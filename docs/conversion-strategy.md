...
The primary page goals are defined in `src/config/page-goals.ts`.

- Home: Request Quotation.
- Products: Add to RFQ.
- Product Details: Add to RFQ.
- Catalogs: Request Catalog.
- Private Label: Start Private Label Inquiry.
- Quality Control: Build Trust / Request Quotation.
- About: Speak With INCAR.
- RFQ: Submit RFQ.
- Contact: Contact via WhatsApp.

Secondary CTAs may support exploration, but they should not visually compete with the primary action.
...
Sourcing requests allow buyers to ask for parts not listed on the website. Buyers should be encouraged to send part numbers, OEM numbers, vehicle model details, category needs, or product photos.

## No Ecommerce Policy

INCAR should remain RFQ-first. The website must not add Buy Now, Add to Cart, checkout, payment, place-order, or retail shopping-bag behavior.
