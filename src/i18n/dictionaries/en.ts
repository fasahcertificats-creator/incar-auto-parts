export const en = {
  ...
  pages: {
    ...
    bulkList: {
      ...
      steps: ["Upload", "Map columns", "Processing"],
      ...
      inspectionTitle: "Choose the source and map columns",
      reference: "Reference",
      worksheet: "Worksheet",
      ...
      queuedHelp: "Your list is safely queued. It will remain here while the worker is unavailable.",
