...
export function ProductImage({ src, alt, brand, partNumber }: ProductImageProps) {
  return (
    <div className="relative aspect-[4/3] overflow-hidden rounded-md border border-border bg-surface-elevated">
      ...
      <div className="absolute left-4 top-4 rounded-sm border border-metallic-silver/20 bg-background/88 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-white">
        {brand}
      </div>
      <div className="absolute bottom-4 right-4 rounded-sm bg-soft-silver px-3 py-1 text-[11px] font-semibold text-ink shadow-sm">
        {partNumber}
      </div>
