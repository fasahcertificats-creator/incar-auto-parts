      ...
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.82fr_1.18fr]">
        <div>
          ...
          <h2 className="mt-4 text-3xl font-semibold leading-tight text-white md:text-5xl">
            Quality support built around private label trust.
          </h2>
          <p className="mt-5 text-lg leading-8 text-muted">
            Saudi wholesale buyers need consistent products, accurate labels,
            and packaging that matches the approved plan. INCAR supports quality
            checkpoints from supplier screening through pre-shipment review.
          </p>
        </div>
